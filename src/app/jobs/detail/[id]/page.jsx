...
function page({ params }) {
    ...
    return (
        <div className="min-h-screen bg-gray-100 px-8 py-36">
            <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-10">
                {/* Left Main Box */}
                <div className="lg:w-2/3 w-full bg-white rounded-2xl shadow-md p-10">
                    <h1 className="text-5xl font-bold text-blue-600 mb-6">{job.title}</h1>
            ...
            <div className="max-w-7xl mx-auto mt-10 flex flex-col sm:flex-row justify-center gap-8">
                <Link href='/account/login'>
                    <button className="bg-gray-800 hover:bg-black text-white px-12 py-5 rounded-full font-bold text-xl">
                        Login to Save
                    </button>
                </Link>
                <Link href='/account/login'>
                    <button className="bg-blue-600 hover:bg-blue-700 text-white px-12 py-5 rounded-full font-bold text-xl">
                        Login to Apply
                    </button>
                </Link>
            </div>
